...
// 源目录
const srcPath = 'src/'
const srcPathHtml = srcPath
const srcPathCss = srcPath + 'css/'
const srcPathJs = srcPath + 'js/'
...
// 开发
gulp.task('default', ['views', 'sass', 'es6', 'staticdev'], () => {
	...
	gulp.watch(srcPathStatic + '**', ['staticdev'])
})

// 生产
gulp.task('build', ['clean', 'viewsbuild', 'cssmin', 'jsmin', 'staticbuild'])